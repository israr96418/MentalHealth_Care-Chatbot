...
# create embedding of that chunkc
embedding = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2",
                                   model_kwargs={'device':"cpu"})

# store embedding into vectordatabase , so we have different types of vector store like FAISS, pineconde etc
vector_stores = FAISS.from_documents(text_chunks, embedding)
